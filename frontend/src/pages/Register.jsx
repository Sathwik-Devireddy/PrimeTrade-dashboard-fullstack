...
import { SquareCheck, Mail, Lock, User, ArrowRight, LoaderCircle } from "lucide-react";
    ...
    >
      <div className="glass-card rounded-[3rem] p-12 relative overflow-hidden">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/40 font-medium">Join the next generation of task management.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-6 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-blue-400 transition-colors" size={20} />
              <input
                type="text"
                required
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 ml-4">Email Address</label>
            <div className="relative group">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 ml-4">Access Key</label>
            <div className="relative group">
        ...
        <div className="mt-10 text-center">
          <p className="text-white/30 text-sm font-medium">
            Already registered?{" "}
            <Link to="/" className="text-white hover:text-blue-400 transition-colors font-bold underline-offset-4 decoration-white/20 underline">
              Return to Login
            </Link>
          </p>
        </div>
